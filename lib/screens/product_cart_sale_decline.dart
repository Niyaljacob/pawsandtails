...
class ProductCartSaleDecline extends StatelessWidget {
  const ProductCartSaleDecline({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('product_cart_payment_decline').snapshots(),
